...
- 2026-05-26: ChromeでのUI確認はアプリ本体を優先し、Web確認時もスマホフレーム単体を中央に表示する構成へ変更。
- 2026-05-26: 暫定テキスト記号を廃止し、`expo-symbols` ベースの共通アイコンコンポーネントとコード製レシートロゴを追加。タブ、検索、設定、撮影、一覧、出力、プラン画面へ適用。
- 2026-05-26: ホーム人物イラスト、店舗/カテゴリ別レシートアバター、CSV形式ブランドバッジ、撮影画面レシート質感を追加し、モックに近い専用ビジュアルへ寄せる。
